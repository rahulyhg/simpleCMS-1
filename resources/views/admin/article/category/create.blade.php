                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h2 class="h5 display">Create new category</h2>
                        </div>
                        <div class="card-body">
                            {!! Form::open(['url' => route('category.store'), 'class' => 'form-horizontal', 'method' => 'post'])!!}

                            <div class="form-group row">
                                {!! Form::label('title', 'Name', ['class' => 'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                                    {!! Form::text('name', old('name'), ['class' => 'form-control form-control-success', 'placeholder' => 'Enter name of category...']) !!}
